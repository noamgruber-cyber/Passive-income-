...
export const metadata = { title: 'Course Moderation | Admin | LearnHub' }
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-100">
              <tr>
                ...
                <th className="text-left px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wide">Instructor</th>
